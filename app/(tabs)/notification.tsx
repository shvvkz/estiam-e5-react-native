 ...
 * NotificationScreen
 *
 * Debug and testing screen dedicated to notification features.
 *
 * This screen allows developers and testers to:
 * - Initialize notification permissions
 * - Retrieve and display the push token
 * - Send immediate local notifications
 * - Schedule notifications with a delay
 * - Manage application badge count
 * - Observe received and interacted notifications
 *
 * The screen adapts its behavior depending on the environment:
 * - Simulator: limited push notification capabilities
 * - Physical device: full push notification support
 *
 * This screen is intended for development and testing purposes
 * and should not be exposed to end users in production builds.
 */
export default function NotificationScreen() {
  ...
  /**
    * addTestResult
    *
    * Appends a timestamped message to the notification test log.
    *
    * This helper function is used to track:
    * - Notification lifecycle events
    * - User interactions with notifications
    * - Errors and system feedback during testing
    *
    * All messages are prepended with the current local time
    * to improve traceability during debugging sessions.
    */
   ...
   * handleInitialize
   *
   * Initializes the notification system for the application.
   *
   * Responsibilities:
   * - Request notification permissions from the user
   * - Register the device for push notifications
   * - Retrieve and display the push token and device metadata
   *
   * This function should be called before attempting
   * to send or schedule notifications.
   */
   ...
   *
   * Sends or schedules a local notification for testing purposes.
   *
   * Depending on the action, this handler may:
   * - Send an immediate local notification
   * - Schedule a notification for a future date
   * - Attach custom metadata to the notification payload
   *
   * These handlers are used to validate notification behavior
   * and system reliability during development.
   */
